...
def generate_launch_description():
    ...
    model_launch_arg = DeclareLaunchArgument("model", default_value=os.path.join(get_package_share_directory("niryo_one_description"), "urdf/v2/niryo_one.urdf.xacro"))
    ...
    robot_description = ParameterValue(Command(['xacro ',os.path.join(get_package_share_directory("niryo_one_description"), "urdf/v2/niryo_one.urdf.xacro")]), value_type=str)  
    ...
    slider_control_node = Node(
        package="test_niryo_v2",
        executable="test_niryo_v2_node",
        # parameters=[
